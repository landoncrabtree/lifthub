...
const EXERCISES = [
  ...
  { name: 'Chest Press (Dumbbell)', muscle_group: 'chest', equipment: 'dumbbell', description: 'Compound press targeting the pectoralis major with greater range of motion than barbell. Independent arms improve muscle balance and allow a deeper chest stretch.' },
  { name: 'Chest Press (Machine)', muscle_group: 'chest', equipment: 'machine', description: 'Machine press targeting the pectoralis major, anterior deltoids, and triceps. Fixed path provides stability for consistent chest activation.' },
  ...
  { name: 'Incline Chest Press (Dumbbell)', muscle_group: 'chest', equipment: 'dumbbell', description: 'Compound press targeting the clavicular (upper) pectoralis major with greater range of motion than barbell. Independent arms allow a deeper stretch and natural pressing path.' },
  { name: 'Incline Chest Press (Machine)', muscle_group: 'chest', equipment: 'machine', description: 'Machine-guided incline press targeting the clavicular (upper) pectoralis major. Fixed path provides stability and consistent resistance through the full range of motion.' },
  ...
  { name: 'Decline Chest Press (Dumbbell)', muscle_group: 'chest', equipment: 'dumbbell', description: 'Compound press targeting the costal (lower) pectoralis major with independent arm movement. Decline angle emphasizes the lower chest with greater range of motion.' },
